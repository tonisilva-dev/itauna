...
-- Script 009 — Dados reais de rateio mensal (Nov/2025 a Abr/2026)
-- Fonte: PDFs oficiais assinados pelo síndico e contador
-- ATENÇÃO: apaga lançamentos existentes antes de reinserir
-- ================================================================

-- 1. Limpar dados antigos da tabela finances
TRUNCATE public.finances RESTART IDENTITY CASCADE;

-- 2. Reinserir com dados reais por mês/categoria
DO $$
DECLARE
  adm UUID;
BEGIN
  -- Tenta encontrar um admin; se não houver, usa NULL (created_by é opcional)
  SELECT id INTO adm FROM public.profiles
  WHERE role IN ('admin', 'sindico') ORDER BY created_at LIMIT 1;
  -- adm pode ficar NULL — a coluna created_by aceita NULL

  -- ════════════════════════════════════════════════
  -- NOV/2025 — Vencimento: 10/12/2025
  -- Total Rateio: R$ 189.430,77
  -- ════════════════════════════════════════════════
  ...
  -- ════════════════════════════════════════════════
  -- DEZ/2025 — Vencimento: 10/01/2026
  -- Total Rateio: R$ 207.882,40
  -- ════════════════════════════════════════════════
  INSERT INTO public.finances (type, category, description, amount, due_date, payment_date, status, reference_month, created_by) VALUES
  ...
  -- ════════════════════════════════════════════════
  -- JAN/2026 — Vencimento: 10/02/2026
  -- Total Rateio: R$ 208.444,10
  -- ════════════════════════════════════════════════
  INSERT INTO public.finances (type, category, description, amount, due_date, payment_date, status, reference_month, created_by) VALUES
  ...
  -- ════════════════════════════════════════════════
  -- FEV/2026 — Vencimento: 10/03/2026
  -- Total Rateio: R$ 197.289,53
  -- ════════════════════════════════════════════════
  INSERT INTO public.finances (type, category, description, amount, due_date, payment_date, status, reference_month, created_by) VALUES
  ...
  -- ════════════════════════════════════════════════
  -- MAR/2026 — Vencimento: 10/04/2026
  -- Total Rateio: R$ 190.019,72
  -- ════════════════════════════════════════════════
  INSERT INTO public.finances (type, category, description, amount, due_date, payment_date, status, reference_month, created_by) VALUES
  ...
  -- ════════════════════════════════════════════════
  -- ABR/2026 — Vencimento: 10/05/2026
  -- Total Rateio: R$ 187.788,19
  -- ════════════════════════════════════════════════
  INSERT INTO public.finances (type, category, description, amount, due_date, payment_date, status, reference_month, created_by) VALUES
  ...
  RAISE NOTICE 'Rateios reais inseridos: Nov/2025 a Abr/2026 (% linhas).',
    (SELECT COUNT(*) FROM public.finances);
END;
$$;
