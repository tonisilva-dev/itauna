...
import {
  ...
  TrendingUp, ClipboardList, Eye, LockKeyhole,
} from 'lucide-react';
...
const MODULES: ModuleCard[] = [
  ...
  { path: '/usuarios',           label: 'Usuários',    desc: 'Gestão de equipe gestora',         Icon: ShieldCheck,  color: '#57d8ff', bg: 'rgba(87,216,255,0.12)',  nivel: 'gestor' },
  { path: '/acessos',            label: 'Acessos',     desc: 'Permissões e perfis de acesso',    Icon: Lock,         color: '#5a84ff', bg: 'rgba(90,132,255,0.12)',  nivel: 'gestor' },
