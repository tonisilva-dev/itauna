...
const CATEGORIAS: Categoria[] = [
  'Condomínio', 'Emergência', 'Saúde', 'Utilidades', 'Poder Público', 'Outros',
];
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            {tel.categoria === 'Condomínio' && (
              <a href={waUrl(tel.telefone)} target="_blank" rel="noopener noreferrer"
                ...
                style={{
                  ...
                  textDecoration: 'none', fontSize: 11, fontWeight: 700, color: '#25D366',
                }}>
                <WaIcon /> WhatsApp
              </a>
            )}
